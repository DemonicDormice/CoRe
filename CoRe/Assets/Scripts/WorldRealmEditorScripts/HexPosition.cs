...
public class HexPosition {
	...
	public HexPosition (int c, int r)
	{
		this.C = c;
		this.R = r;
		this.S = -(c + r);
	...
	public static float Distance (HexPosition a, HexPosition b) //this calculates the distance between hexes for RealmMap_Continent.RandomArea
	{
